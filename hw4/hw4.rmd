...
We work with a multiple subsets of the data throughout this report. The following uses only the sums of the questionnaires in order to reduce the number of variables.
...
adhd.complete$EducationLevel <- ifelse(adhd.complete$Education <= 8, 1, ifelse(adhd.complete$Education <= 12 & adhd.complete$Education > 8, 2, ifelse(adhd.complete$Education > 12, 3, 99)))
